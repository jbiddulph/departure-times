<template>
  <div v-if="loading" class="overflow-hidden justify-center">
    <svg class="mt-32 animate-spin flex justify-center align-center w-full h-8 overflow-hidden" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" fill="white" xmlns:xlink="http://www.w3.org/1999/xlink" width="30" height="30" x="0px" y="0px"
    ...
    <h3 class="text-center text-white mt-4">Fetching departure times</h3>
  </div>
</template>
